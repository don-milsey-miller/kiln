    ...
    const wrongEnv = await createEvidence(
      {
        ...
        environment: { execution: "controller", sandboxTier: 2, isolationBoundary: { isolates: ["filesystem", "process", "network-namespace"], doesNotClaim: ["kernel-isolation"] }, facts: { os: "Ubuntu 24", postgres: "17" } },
    ...
    const validated = await createEvidence(
      {
        ...
        environment: { execution: "controller", sandboxTier: 2, isolationBoundary: { isolates: ["filesystem", "process", "network-namespace"], doesNotClaim: ["kernel-isolation"] }, facts: { ...TARGET, image: "rhel10-pg17" } },
        observedAt: "2026-08-18",
        outcome: "success",
      },
      o
