...
import { createAssertion, createEvidence, createRunbookStep, createQuestion, createDecision, linkEvidence, unlinkEvidence, reviseArtifact, setLifecycle } from "./evidence-tools.mjs";
...
export const MUTATION_TOOLS = { linkEvidence, unlinkEvidence, reviseArtifact, setLifecycle };
