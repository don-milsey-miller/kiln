...
import { createAssertion, createEvidence, createRunbookStep, createQuestion, createDecision, createComponent, linkEvidence, unlinkEvidence, reviseArtifact, setLifecycle, resolveQuestion } from "./evidence-tools.mjs";
...
export const MUTATION_TOOLS = { linkEvidence, unlinkEvidence, reviseArtifact, setLifecycle, resolveQuestion };
