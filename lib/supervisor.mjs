...
export async function runSupervisor(deps) {
  ...
  // An inherited keyboard-stop path names some other run's notice: no child gets one this run did not create.
  for (const name of Object.keys(baseEnv)) if (name.toUpperCase() === KEYBOARD_STOP_ENV) delete baseEnv[name];
