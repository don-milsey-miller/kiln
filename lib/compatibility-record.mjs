 ...
 * identity and none was given, there is no key, and so nothing can be cached: the canary simply re-runs.
 *
 ...
 * the canary then re-runs next time, which costs a request and leaks nothing.
 *
