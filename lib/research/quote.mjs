...
export function extractTitle(html) {
  ...
  // ⚠️ Runs through visibleText so entities are decoded. The first version did not, and the first
  // real record it produced was stored as "Credits &amp; Pricing - Tavily Docs" — a title that is
  // wrong in the one place it will be read, the citation.
  return m ? flatten(visibleText(m[1])) : null;
}
