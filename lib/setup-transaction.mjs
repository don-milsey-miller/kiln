 ...
 *
 * @param {unknown} tx
 * @returns {{projectRoot: string, active: boolean, roots: {project: string, state?: string}, stateMode: string|null}|null}
 */
...
async function execute(plan, body, opts) {
   ...
   */
  const record = { projectRoot: plan.projectRoot, roots: plan.roots, stateMode: plan.stateMode, active: true, enrol: null };
