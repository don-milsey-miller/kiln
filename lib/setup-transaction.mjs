 ...
 *
 * @param {unknown} tx
 * @returns {{projectRoot: string, active: boolean, roots: {project: string, state?: string}}|null}
 */
...
async function execute(plan, body, opts) {
   ...
   */
  const record = { projectRoot: plan.projectRoot, roots: plan.roots, active: true, enrol: null };
